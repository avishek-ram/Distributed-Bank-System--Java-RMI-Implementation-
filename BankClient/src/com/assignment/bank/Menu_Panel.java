...
public class Menu_Panel extends javax.swing.JFrame {
    ...
    void get_bal()
    {
        try
        {
            ...
            acc_bal = "<html><p style=\"text-align:center;\"> AVAILABLE BALANCE <br><br>FJD "+Main_Driver.bank_pros.checkBalance(Main_Driver.acc_num);
